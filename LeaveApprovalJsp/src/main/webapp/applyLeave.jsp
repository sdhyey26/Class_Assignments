...
<div class="form-container">
    <form method="post" action="ApplyLeaveServlet" name="leaveForm" onsubmit="return validateDates()">
...
function validateDates() {
    const start = new Date(document.forms["leaveForm"]["start_date"].value);
    const end = new Date(document.forms["leaveForm"]["end_date"].value);
